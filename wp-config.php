...
define('DB_NAME', 'aloeveraforever');
/** Utilisateur de la base de données MySQL. */
define('DB_USER', 'aloeveraforever');
/** Mot de passe de la base de données MySQL. */
define('DB_PASSWORD', 'aloeveraforever');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'U>BFYyu7P_/pX|Ly<&H6-Z${[jh+{m+$d xJ_H~*Pf^,4V-2pRvSl*qj-,%]Z2H$');
  define('SECURE_AUTH_KEY',  'I+%C64III<M*1-J5DM=e?7v^bqltfqIlu7=p/cFa[a1|Q)d(LZUw=u<ab:|]va5*');
  define('LOGGED_IN_KEY',    ',CMNkMpH)v7zP>rtb4yzRpt`EXyL-*r<*+vXa$6i;~;AVF$f?Obw [5wcJ<!&|yf');
  define('NONCE_KEY',        'WQ-K3JAsn-izg.aG|T$D--]+AFYS-&u>=4}h8/]yoNJ;Rgb]/dBJWZq$<+$f66$g');
  define('AUTH_SALT',        '8a.|CT:;2j^?XeBeEm+QlqzD1N)Q `+/euk*u-Mn`Esb<^&(>c2bEvI$E0F|?Q,W');
  define('SECURE_AUTH_SALT', '`=c5/gr=?C?oGh,Hh4q^7&B,w &g3Z5Hxrt~Ivg-r^R*|l`V=&NgWSa|lW,s&n@e');
  define('LOGGED_IN_SALT',   '*#x|+XN7Qjew/e~o987]-G9<OL%3W4BByWZ<d;_L1O;,abx`icAm<D(e:-J,2rdP');
  define('NONCE_SALT',       '^ZhC*Ubx HcR4+cc%sc#KIb{4-}!S+/nc#Qk)B)Aus|GV l@oY@]?Nu)$|r~J~YH');
/**#@-*/
// define( 'SMTP_USER',   'namaste@alloyogi.com' );    // Username to use for SMTP authentication
// define( 'SMTP_PASS',   'Rkpk7f321%' );       // Password to use for SMTP authentication
// define( 'SMTP_HOST',   'ssl0.ovh.net' );    // The hostname of the mail server
// define( 'SMTP_FROM',   'namaste@alloyogi.com' ); // SMTP From email address
// define( 'SMTP_NAME',   'Allo Yogi - Le portail du yoga francophone' );    // SMTP From name
 ...
 */
define( 'WP_HOME', rtrim( 'http://localhost:8888/aloeveraforever', '/' ) );
/**
