...
function add_google_recaptcha($submit_field) { 
  $submit_field['submit_field'] = '<div class="g-recaptcha" data-sitekey="6LfElE0jAAAAACHRSqDM1nJRTutsYpYJLL8z0r4a"></div>'.$submit_field['submit_field']; 
  return $submit_field; 
} 
...
function is_valid_captcha_response($captcha) { 
  $captcha_postdata = http_build_query( 
      array( 
          'secret' => '6LfElE0jAAAAAE-Zi2ptV4p3tOpNryoKglyQmGG5', 
          'response' => $captcha, 
